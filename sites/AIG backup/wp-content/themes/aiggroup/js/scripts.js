jQuery(function ($) {
  ...
  $('.modal > div > div > div.modal-header > iframe').height($(window).height() * 0.8);
...
Modernizr.load([
  {
    ...
    nope: [
      ale.template_dir + '/js/libs/selectivizr.min.js',
      ale.template_dir + '/js/libs/respond.min.js',
    ],
  },
  {
...
jQuery(function ($) {
  ...
  $('.get_buy_popup_service').click(function () {
    // задаем функцию при нажатиии на элемент с классом toggle
    // var all_form_field = $(this).siblings();
  ...
  $('#buyForm #closePopUp').click(function () {
    // задаем функцию при нажатиии на элемент с классом toggle
    $('#buy_pop_up_block').toggle(); //  скрываем, или отображаем все элементы <div>
  });
  ...
  $('.fon_pop_up_buy').click(function () {
    // задаем функцию при нажатиии на элемент с классом toggle
    $('#buy_pop_up_block').toggle(); //  скрываем, или отображаем все элементы <div>
  });

  $('.fon_pop_up_thank').click(function () {
    // задаем функцию при нажатиии на элемент с классом toggle
    $('#pop_up_thank').toggle(); //  скрываем, или отображаем все элементы <div>
  });

  $('#callBackForm #closePopUp').click(function () {
    // задаем функцию при нажатиии на элемент с классом toggle
    $('#pop_up_block').toggle(); //  скрываем, или отображаем все элементы <div>
  });

  $('#closePopUpThank').click(function () {
    // задаем функцию при нажатиии на элемент с классом toggle
    $('#pop_up_thank').toggle(); //  скрываем, или отображаем все элементы <div>
  });

  $('.fon_pop_up').click(function () {
    // задаем функцию при нажатиии на элемент с классом toggle
    $('#pop_up_block').toggle(); //  скрываем, или отображаем все элементы <div>
  });

  $('#get_sale_phone').click(function () {
    // задаем функцию при нажатиии на элемент с классом toggle
    $('#pop_up_block').toggle(); //  скрываем, или отображаем все элементы <div>
  ...
  $('#get_consultation_phone').click(function () {
    // задаем функцию при нажатиии на элемент с классом toggle
    $('#pop_up_block').toggle(); //  скрываем, или отображаем все элементы <div>
  ...
  function show_callback_responsed_issue(response) {
    // показываем принятые данные заявки на обратный звонок
  ...
  function getRecaptcha() {
    grecaptcha.ready(function () {
      grecaptcha
        .execute('6LeqYt4UAAAAAAvOa5Qtd50tcfOWppt_jSJmsxvh', { action: 'homepage' })
        .then(function (token) {
  ...
  $('#get_buy').click(function (event) {
    ...
    $('#buyForm').each(function () {
      ...
      $.ajax({
        url: ajax_path,
        type: 'POST',
        data: data_toSend, // можно также передать в виде объекта
