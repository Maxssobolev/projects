				...
				$result .='
					<div class="testimonial-'.$themes.'">
						...
						<div class="testimonial-description-profiles-'.$themes.'">
							<span class="testimonial-description-title-'.$themes.'">'.esc_attr($client_name_value).'</span><small><span target="'.$company_url_target.'" href="'.esc_url($company_url).'">'.$link_value.'</span></small>
						</div>
					</div>';
			endwhile;
			$result .='</div>';
