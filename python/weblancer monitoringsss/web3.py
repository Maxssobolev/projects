...
def send_message(message):
	vk_session.method('messages.send',{'user_id': 247398975, 'random_id': int(time.time()**7), 'message':message})


token = "c067f6d5d251a343def6605cb6be50e52b1482d917298b71a01eefe0895b6186f5ebc4342436607dfbd08"
...
#-------AFTER
	...
	if browser.title != 'Вы не авторизованы':  	
		...
		try:
			...
			send_message('Ошибка при авторизации')
	
	if messsage:
		send_message(messsage['response'])
		send_message('Ответить? [Да/Нет]  ')
		...
		if get_message() == 'да':
			...
			send_message('Введите ответное сообщение')
